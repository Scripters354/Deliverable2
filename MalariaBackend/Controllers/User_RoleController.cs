...
namespace MalariaBackend.Controllers
{
    public class User_RoleController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "User_Role_ID,User_Role_Description")] User_Role user_Role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "User_Role_ID,User_Role_Description")] User_Role user_Role)
        {
            if (ModelState.IsValid)
            {
